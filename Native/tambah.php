...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form action="p_tambah.php" name="modal_popup" enctype="multipart/form-data" method="POST">
          <div class="form-group" style="display:none;padding-bottom: 20px;">
          ...
          <div class="form-group" style="padding-bottom: 20px;">
          	<label for="total_kas">Tambah Berapa?</label>
			      <input type="number" name="last_add"  class="form-control" placeholder="0"/>
          </div>
